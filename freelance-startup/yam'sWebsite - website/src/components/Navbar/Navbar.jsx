...
const Navbar = ({ isSignedIn }) => {
  ...
  return (
    <div className="bg-white flex justify-between p-5 px-10 align-middle items-center min-h-[89.5px] relative overflow-hidden ">
      {/* Logo */}
      <div className={`${isOpen && "hidden"}`}>{renderLogo()}</div>
      {/* Render navigation items */}
      ...
      {/* mobile nav */}
      {isOpen && (
        <div className="mobile_nav_menu absolute bg-white bg-opacity-50 backdrop-blur-sm h-screen w-full z-10 inset-0 flex flex-col justify-center items-center gap-5 ">
          <RxCross1
